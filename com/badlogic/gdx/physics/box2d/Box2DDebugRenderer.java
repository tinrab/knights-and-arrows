...
public class Box2DDebugRenderer {
   ...
   private void renderBodies(World world) {
      ...
      if (this.drawBodies || this.drawAABBs) {
         ...
         while(true) {
            ...
            do {
               ...
               body = (Body)iter.next();
            } while(!body.isActive() && !this.drawInactiveBodies);
      ...
      if (this.drawContacts) {
         ...
         for(int i = 0; i < len; ++i) {
            this.drawContact((Contact)world.getContactList().get(i));
         }
   ...
   protected void renderBody(Body body) {
      ...
      Iterator var4 = body.getFixtureList().iterator();

      while(var4.hasNext()) {
         Fixture fixture = (Fixture)var4.next();
         if (this.drawBodies) {
