...
public class ObjectMap<K, V> {
   ...
   public void putAll(ObjectMap<K, V> map) {
      ...
      while(var3.hasNext()) {
         ObjectMap.Entry<K, V> entry = (ObjectMap.Entry)var3.next();
   ...
   public static class Entries<K, V> extends ObjectMap.MapIterator<K, V> implements Iterable<ObjectMap.Entry<K, V>>, Iterator<ObjectMap.Entry<K, V>> {
   ...
   public static class Keys<K> extends ObjectMap.MapIterator<K, Object> implements Iterable<K>, Iterator<K> {
   ...
   public static class Values<V> extends ObjectMap.MapIterator<Object, V> implements Iterable<V>, Iterator<V> {
